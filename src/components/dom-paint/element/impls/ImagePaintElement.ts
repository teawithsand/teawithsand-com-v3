 ...
 */
export default class ImagePaintElement
	implements
		AABBPaintElement<ImagePaintElementData>,
		PointCollisionPaintElement<ImagePaintElementData>
{
	...
	updateData = (
		updater: (data: ImagePaintElementData) => ImagePaintElementData
	): void => {
