 ...
 */
export default class TextPaintElement
	implements
		AABBPaintElement<TextPaintElementData>,
		PointCollisionPaintElement<TextPaintElementData>
{
	...
	updateData = (
		updater: (data: TextPaintElementData) => TextPaintElementData
	): void => {
