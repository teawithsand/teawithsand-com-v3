 ...
 */
export default interface PaintElement<
	T extends PaintElementData = PaintElementData
> extends RenderHashable<T> {}

export interface AABBPaintElement<T extends PaintElementData = PaintElementData>
	extends PaintElement<T> {
	/**
...
export interface PointCollisionPaintElement<
	T extends PaintElementData = PaintElementData
> extends PaintElement<T> {
	/**
