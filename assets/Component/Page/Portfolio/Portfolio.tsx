...
export default () => {
    const palmabooksABookGalleryImages: GalleryImage[] = useMemo(() => {
        const images = [
            screenZero,
            screenOne,
            screenTwo,
    ...
    return <main className={styles.pageContainer}>
        <article>
            ...
            <div className={styles.features}>
                <div className={classnames(styles.feature, teawithsandComV3Toggle.toggled ? styles.featureActive : null)}>
                    <div className={styles.featureHeader}>
                        <h2 className={styles.featureHeaderTitle}>teawithsand.com v3 website</h2>
                        <button onClick={() => teawithsandComV3Toggle.toggle()} className={styles.featureHeaderButton}>
                            {teawithsandComV3Toggle.toggled ? "Show less" : "Show more"}
                        </button>
                ...
                <div className={classnames(styles.feature, teawithsandComV12Toggle.toggled ? styles.featureActive : null)}>
                    <div className={styles.featureHeader}>
                        <h2 className={styles.featureHeaderTitle}>teawithsand.com v1 and v2</h2>
                        <button onClick={() => teawithsandComV12Toggle.toggle()} className={styles.featureHeaderButton}>
                            {teawithsandComV12Toggle.toggled ? "Show less" : "Show more"}
                        </button>
                        <p className={styles.featureHeaderSubtitle}>
                            2022.01 - 2022.03 <br />
                            Past versions of this website with backend and different features <br />
                ...
                <div className={classnames(styles.feature, palmabooksABookToggle.toggled ? styles.featureActive : null)}>
                    <div className={styles.featureHeader}>
                        <h2 className={styles.featureHeaderTitle}>PalmABooks / PalmABooks2 ABook player</h2>
                        <button onClick={() => palmabooksABookToggle.toggle()} className={styles.featureHeaderButton}>
                            {palmabooksABookToggle.toggled ? "Show less" : "Show more"}
                        </button>
                        <p className={styles.featureHeaderSubtitle}>
                            2017.03 - 2019.01<br />
                            Screenshots available <br />
                            <a href={Palmabooks2LatestAPK} download="palmabooks2_latest.apk">
                    ...
                    <Collapse in={palmabooksABookToggle.toggled}>
                        <div className={styles.featureContent}>
                            <p>
                                Quick note here: PalmABooks was the first ABook player. PalmABooks2 uses most of the codebase and general ideas from previous version.
                                Consider PalmABooks 2 newer version of the same app.
                                <br /><br />
                                PalmABooks 2 is native android ABook players written java and kotlin(since at the beginning of development, kotlin was not official android programming language).
                            ...
                            <p>
                                PalmABooks2 also had small Spring Boot backend, which scrapped{" "}
                                <a target="_blank" href="https://librivox.org/api/info">librivox</a> and{" "}
                                <a href="https://wolnelektury.pl/api/" target="_blank">wolnelektury.pl</a> APIs, stored data in PostgreSQL and
                            ...
                            <ul>
                                ...
                                <li>Widget</li>
                                <li>Support for .mp3, .m4a, .wmv, .wav, .ogg, .m4b files</li>
                            </ul>
                            <p>
                                Technologies used in android app: Android SDK, Kotlin, Java
                                Technologies used on the backend: Spring Boot, hibernate, PostgreSQL
                            </p>
                            <p>
                                <a className={styles.downloadButton} href={Palmabooks2LatestAPK} download="palmabooks2_latest.apk">
                                    Download palmabooks2_latest.apk
                                </a>
                            </p>
                            <h3>Screenshots</h3>
                            <Gallery
                                images={palmabooksABookGalleryImages}
                            />
                        </div>
                    </Collapse>
                </div>

                <div className={classnames(styles.feature, palmabooksComToggle.toggled ? styles.featureActive : null)}>
                    <div className={styles.featureHeader}>
                        <h2 className={styles.featureHeaderTitle}>palmabooks.com website</h2>
                        <button onClick={() => palmabooksComToggle.toggle()} className={styles.featureHeaderButton}>
                            {palmabooksComToggle.toggled ? "Show less" : "Show more"}
                        </button>
                        <p className={styles.featureHeaderSubtitle}>
                            2018.02 - 2018.09<br />
                            Available at <a href={palmabooksComArchiveOrgLink}>archive.org</a>
                        </p>
                    </div>
                    <Collapse in={palmabooksComToggle.toggled}>
                        <div className={styles.featureContent}>
                            <p>
                                Note: this project is not the one, which powered PalmABooks2 application.
                            </p>
                            <p>
                            ...
                            <ul>
                                ...
                                <li>
                                    Basic user management routines: changing email, changing password, resetting forgotten password and deleting account.
                                </li>
                                <li>
                                    Tracking and graying-out already clicked blog posts
                                </li>
                                <li>
                                    Favorite blog list
                                </li>
                                <li>
                                    List of blog posts from favorite blogs
                                </li>
                                <li>
                            ...
                            <p>
                                Technologies used: PHP, Symfony, JavaScript, jQuery, Bootstrap, PostgreSQL
                            </p>
                            <p>
                                <a className={styles.downloadButton} href={palmabooksComArchiveOrgLink}>See at archive.org</a>
                            </p>
                        </div>
                    </Collapse>
                </div>

                <div className={classnames(styles.feature, othersToggle.toggled ? styles.featureActive : null)}>
                    <div className={styles.featureHeader}>
                        <h2 className={styles.featureHeaderTitle}>Other projects</h2>
                        <button onClick={() => othersToggle.toggle()} className={styles.featureHeaderButton}>
